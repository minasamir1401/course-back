...
function main() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const superAdmin = yield prisma.user.findFirst({
            where: { role: 'SUPER_ADMIN' }
        });
        if (!superAdmin) {
            throw new Error('Super Admin user not found! Aborting to protect data integrity.');
        }
        const allSchools = yield prisma.school.findMany();
        ...
        yield prisma.subExam.deleteMany();
        yield prisma.examModule.deleteMany();
        console.log('3. Deleting all existing exams and folders...');
        yield prisma.exam.deleteMany();
        yield prisma.examFolder.deleteMany();
        ...
        const lessonQuestions = courseSlides.filter(s => s.type === 'QUESTION').map((q, idx) => {
            ...
            return ({
                ...
                level: q.level,
                explanation: ((_a = q.sections[0]) === null || _a === void 0 ? void 0 : _a.content) || '',
                explanationEn: ((_b = q.sections[0]) === null || _b === void 0 ? void 0 : _b.contentEn) || '',
                sections: q.sections
            });
        });
        const createdCourse = yield prisma.course.create({
            data: {
                ...
                grades: JSON.stringify(['الصف الأول الإعدادي', 'الصف الأول الثانوي', 'الصف الثاني الثانوي', 'الصف الثالث الثانوي']),
                subject: 'Mathematics',
                isCentral: true,
        ...
        const createdExam = yield prisma.exam.create({
            data: {
        ...
        const skillCluster = yield prisma.skillCluster.create({
            data: {
                ...
                isCentral: true,
                creatorId: superAdmin.id,
                schoolId: ((_a = allSchools[0]) === null || _a === void 0 ? void 0 : _a.id) || null,
                skills: {
                    create: [
                        {
